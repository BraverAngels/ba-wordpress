...
<div id="tribe-events-content" class="tribe-events-single">
  ...
  <?php while ( have_posts() ) :  the_post(); ?>
    <div id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
      ...
      <?php preg_match_all('#\bhttps?://[^\s()<>]+(?:\([\w\d]+\)|([^[:punct:]\s]|/))#', $signup_link, $matches); print_r($matches[0]); ?>
      <?php if ($signup_link) : ?>
  ...
  <div id="tribe-events-footer">
    ...
    <nav class="tribe-events-nav-pagination" aria-label="<?php printf( esc_html__( '%s Navigation', 'the-events-calendar' ), $events_label_singular ); ?>">
      <ul class="tribe-events-sub-nav">
        <li class="tribe-events-nav-previous"><a href="<?php echo esc_url( tribe_get_events_link() ); ?>"> <?php printf( '&laquo; ' . esc_html_x( 'All %s', '%s Events plural label', 'the-events-calendar' ), $events_label_plural ); ?></a></li>
      </ul>
      <!-- .tribe-events-sub-nav -->
    </nav>
  </div>
